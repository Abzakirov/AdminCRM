                ...
                items={[
                  {
                    ...
                    children: (
                      <div>
                        ...
                        <p style={{ margin: 0, color: currentTheme.textTertiary }}>{moment(teacherData.work_date).format('DD.MM.YYYY')}</p>
                      </div>
                    )
                  },
                  ...(teacherData.work_end ? [
                    {
                      ...
                      children: (
                        <div>
                          ...
                          <p style={{ margin: 0, color: currentTheme.textTertiary }}>{moment(teacherData.work_end).format('DD.MM.YYYY')}</p>
                        </div>
                      )
                    }
                  ] : [])
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col span={12}>
                  <Statistic
                    ...
                    valueStyle={{ color: isDarkMode ? '#ff4d4f' : '#cf1322' }}
                ...
                <Col span={24}>
                  <Statistic
                    ...
                    value={totalStudents}
                    valueStyle={{ color: isDarkMode ? '#faad14' : '#d48806' }}
                    prefix={<UserOutlined />}
                  />
                </Col>
              </Row>
